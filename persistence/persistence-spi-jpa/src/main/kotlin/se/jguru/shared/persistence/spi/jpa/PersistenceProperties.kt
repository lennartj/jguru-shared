 ...
 */
enum class PersistenceProperties(val property : String,
...
/**
 * Simplified builder to permit chaining properties on the form
 */
class PersistencePropertyBuilder @JvmOverloads constructor(
    ...
    fun with(prop : PersistenceProperties, value : String) : PersistencePropertyBuilder =
