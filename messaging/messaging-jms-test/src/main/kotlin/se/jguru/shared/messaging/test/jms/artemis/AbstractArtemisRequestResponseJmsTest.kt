...
import se.jguru.shared.messaging.test.jms.AbstractRequestResponseJmsTest

/**
 * Abstract Request/Response JMS test which uses an [ArtemisMessageBroker].
 */
abstract class AbstractArtemisRequestResponseJmsTest(
...
) : AbstractRequestResponseJmsTest(useTransactions, ArtemisMessageBroker(brokerName, configurationDirectory))
